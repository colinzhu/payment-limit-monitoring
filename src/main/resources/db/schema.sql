...
CREATE SEQUENCE settlement_seq START WITH 1 INCREMENT BY 1 ORDER;

CREATE TABLE SETTLEMENT (
    ID NUMBER(19) DEFAULT settlement_seq.NEXTVAL PRIMARY KEY,
    ...
    SETTLEMENT_TYPE VARCHAR2(10) NOT NULL,
    IS_OLD NUMBER(1) DEFAULT 0,
    CREATE_TIME TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UPDATE_TIME TIMESTAMP DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT chk_direction CHECK (DIRECTION IN ('PAY', 'RECEIVE')),
    CONSTRAINT chk_settlement_type CHECK (SETTLEMENT_TYPE IN ('GROSS', 'NET')),
    ...
    CONSTRAINT uq_settlement_unique UNIQUE (SETTLEMENT_ID, PTS, PROCESSING_ENTITY, SETTLEMENT_VERSION)
);
